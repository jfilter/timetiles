...
**Event**
A single data point in TimeTiles representing something that happened at a specific time and place. Events are the basic building blocks of datasets.
...
**URL Parameters**
Web address parameters that store filter and view states, allowing users to share specific views of their data.
