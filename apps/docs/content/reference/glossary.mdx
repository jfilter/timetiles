...
**Scheduled Import**
An automated URL-based import that runs on a cron schedule. TimeTiles fetches data from a URL at configured intervals and processes it through the import pipeline.
