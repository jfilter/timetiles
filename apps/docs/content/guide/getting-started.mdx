...
TimeTiles analyzes your data and identifies field types — dates, locations, categories, numbers. Verify the mappings look correct and adjust if needed, especially if your file includes start/end date pairs or a single combined coordinate column.
