...
| -------------------------------------- | ------------------------------------------------------------------------ |
| **TimeScrape Runner** (`apps/scraper`) | Executes scripts in hardened containers. Stateless — no database access. |
...
- [Writing Scrapers](/reference/scrapers/writing-scrapers) — Detailed guide with advanced examples
- [Scraper Deployment](/reference/scrapers/deployment) — Setting up the TimeScrape runner
