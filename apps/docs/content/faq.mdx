...
**To self-host**: Basic Docker and Linux skills. See the [Self-Hosting guide](/self-hosting).
...
Minimum: 2 CPU cores, 4 GB RAM, 20 GB SSD, Docker. Recommended: 4+ cores, 8+ GB RAM, 50+ GB SSD. See [Prerequisites](/self-hosting/installation).
...
Yes — themes, branding, logos, custom CSS, and layout templates. All configurable from the admin dashboard without code changes. See [UI Customization](/self-hosting/ui-customization).
