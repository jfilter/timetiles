...
<Cards num={2}>
  ...
  <Cards.Card title="Development Setup" href="./development" arrow>
    Environment setup, workflows, code standards, and commands.
  </Cards.Card>
</Cards>
...
<Cards num={2}>
  ...
  <Cards.Card title="API Reference" href="/reference/api" arrow>
    Auto-generated TypeDoc documentation for all modules.
  </Cards.Card>
</Cards>
