...
- **Guide** (`/user-guide/`) - Features, use cases, tutorials
- **Development** (`/developer-guide/`) - Architecture, development guides
- **Self-Hosting** (`/admin-guide/`) - Deployment, configuration, maintenance
