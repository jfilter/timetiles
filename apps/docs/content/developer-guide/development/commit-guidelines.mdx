...
The scope provides additional context about what part of the codebase changed. Scopes are organized into categories:
...
- **`docs(docs)`**: Valid when documenting the docs app itself
  - Example: `docs(docs): update README with Nextra setup instructions`
  - Example: `docs(docs): add guide for writing MDX components`
  - Use `docs:` for general documentation changes
  - Use `docs(web):` for documenting the web app
  - Use `docs(docs):` for documentation about the documentation site
