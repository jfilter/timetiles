...
Field renaming and restructuring during ingestion.
...
- Maximum number of ingest-jobs for this dataset running simultaneously
...
**Max Concurrent Ingestion Runs**:

- Maximum number of files being ingested simultaneously across all datasets
