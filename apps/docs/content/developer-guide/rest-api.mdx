...
| `/api/import/*`               | Import schema preview, configure, validate     |
| `/api/import-jobs/*`          | Import job management (reset, retry)           |
...
| `/api/scheduled-imports/*`    | Manual trigger for scheduled imports           |
