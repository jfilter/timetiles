...
| `/api/import/*`               | Ingestion schema preview, configure, validate  |
| `/api/import-jobs/*`          | Ingestion job management (reset, retry)        |
...
| `/api/scheduled-imports/*`    | Manual trigger for scheduled ingestion         |
