...
The API uses URL fetch caching for scheduled imports. See [URL Fetch Cache](/developer-guide/url-fetch-cache) for details.
...
- [URL Fetch Cache](/developer-guide/url-fetch-cache) - Caching for scheduled URL imports
