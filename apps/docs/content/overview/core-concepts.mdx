...
For details on each processing stage, see [Data Import](/user-guide/data-import).
...
- **[Data Import](/user-guide/data-import)** — Formats, geocoding, scheduling, and schema handling
