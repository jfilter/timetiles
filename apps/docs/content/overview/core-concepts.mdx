...
For details on each processing stage, see [Data Import](/guide/data-import).
...
- **[Getting Started](/guide/getting-started)** — Import your first dataset
- **[Data Import](/guide/data-import)** — Formats, geocoding, scheduling, and schema handling
