...
| URL Fetches/Day      | 0     |
| File Uploads/Day     | 1     |
| Events per Ingestion | 100   |
| Total Events         | 100   |
| Ingestion Jobs/Day   | 1     |
| Max File Size        | 1 MB  |
| Catalogs per User    | 1     |
| Scraper Repos        | 0     |
| Scraper Runs/Day     | 0     |
...
| URL Fetches/Day      | 5     |
| File Uploads/Day     | 3     |
| Events per Ingestion | 1,000 |
| Total Events         | 5,000 |
| Ingestion Jobs/Day   | 5     |
| Max File Size        | 10 MB |
| Catalogs per User    | 2     |
| Scraper Repos        | 0     |
| Scraper Runs/Day     | 0     |
...
| URL Fetches/Day      | 20     |
| File Uploads/Day     | 10     |
| Events per Ingestion | 10,000 |
| Total Events         | 50,000 |
| Ingestion Jobs/Day   | 20     |
| Max File Size        | 50 MB  |
| Catalogs per User    | 5      |
| Scraper Repos        | 0      |
| Scraper Runs/Day     | 0      |
...
| URL Fetches/Day      | 100     |
| File Uploads/Day     | 50      |
| Events per Ingestion | 50,000  |
| Total Events         | 500,000 |
| Ingestion Jobs/Day   | 100     |
| Max File Size        | 100 MB  |
| Catalogs per User    | 20      |
| Scraper Repos        | 3       |
| Scraper Runs/Day     | 10      |
...
| Events per Ingestion | 200,000   |
| Total Events         | 2,000,000 |
| Ingestion Jobs/Day   | 500       |
| Max File Size        | 500 MB    |
| Catalogs per User    | 100       |
| Scraper Repos        | 10        |
| Scraper Runs/Day     | 50        |
...
| Events per Ingestion | Unlimited (-1) |
| Total Events         | Unlimited (-1) |
| Ingestion Jobs/Day   | Unlimited (-1) |
| Max File Size        | 1000 MB        |
| Catalogs per User    | Unlimited (-1) |
| Scraper Repos        | Unlimited (-1) |
| Scraper Runs/Day     | Unlimited (-1) |

### Custom Quotas

Set user-specific overrides in the admin panel (`/dashboard/collections/users`):
...
- Admin panel: `/dashboard/collections/users`
