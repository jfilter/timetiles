...
# Restore database
timetiles restore db-20241220-143022.sql.gz

# Restore database and uploads
timetiles restore db-20241220-143022.sql.gz uploads-20241220-143022.tar.gz
```
