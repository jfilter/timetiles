...
<Cards num={2}>
  <Cards.Card title="Dynamic Filters" href="./dynamic-filters" arrow>
    Schema-driven filter generation and SQL/Payload adapters.
  </Cards.Card>
...
<Cards num={2}>
  <Cards.Card title="Language Support" href="./language-support" arrow>
    Multi-language field mapping for event data.
  </Cards.Card>
  <Cards.Card title="Content Localization" href="./content-localization" arrow>
    Payload CMS content i18n with next-intl.
  </Cards.Card>
</Cards>
