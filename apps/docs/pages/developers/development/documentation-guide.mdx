...
**Location:** Various directories under `/apps/docs/pages/`
- **Getting Started** (`/getting-started/`) - Installation, quick start guides
- **User Guides** (`/users/`) - Features, use cases, tutorials
- **Developer Docs** (`/developers/`) - Architecture, development guides
- **Reference** (`/reference/`) - Changelog, roadmap, glossary

These are **hand-written MDX files** that you edit directly.

### 2. Auto-generated API Documentation
**Location:** `/apps/docs/pages/reference/api/`
...
```bash
apps/docs/pages/developers/guides/my-new-guide.mdx
```
...
3. **Output**: Markdown files in `apps/docs/pages/reference/api/`
...
```bash
# Regenerate on source file changes
pnpm docs:api:watch
```
...
- **Output location**: `apps/docs/pages/reference/api/`
...
1. **Main navigation**: `apps/docs/pages/reference/api/_meta.json`
2. **Section navigation**: `apps/docs/pages/reference/api/lib/_meta.json`
...
```gitignore
apps/docs/pages/reference/api/**/*.md
apps/docs/pages/reference/api/**/*.mdx
```

**Tracked (Manual)**:
```gitignore
!apps/docs/pages/reference/api/_meta.json
!apps/docs/pages/reference/api/**/_meta.json
!apps/docs/pages/reference/api/index.mdx
!apps/docs/pages/reference/api/.gitkeep
```
...
rm -rf apps/docs/pages/reference/api/lib
rm -rf apps/docs/pages/reference/api/app

# Regenerate fresh
pnpm docs:api

# Check what's ignored by git
git check-ignore apps/docs/pages/reference/api/**
