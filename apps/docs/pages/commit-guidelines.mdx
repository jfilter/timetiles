...
- Don't capitalize the first letter (except for proper nouns and acronyms)
...
# Why was this change necessary? (wrap at 100 chars)

# How does it address the problem? (wrap at 100 chars)

# Are there any side effects? (wrap at 100 chars)
