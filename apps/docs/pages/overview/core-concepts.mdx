...
1. [Prepare your data](../users/guides/data-preparation) following our format guidelines
2. [Create your first chronicle](../users/guides/creating-chronicles) by importing data
3. [Explore the interface](../users/features) to see all available features
