...
<Callout type="warning" emoji="⚠️">
  **Documentation Under Construction**
  ...
  This documentation is incomplete and actively being developed. Many pages are missing or contain placeholder content. The TimeTiles project itself is in active development and not yet ready for production use.
</Callout>
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', marginTop: '2rem'}}>
  <div style={{padding: '1.5rem', border: '1px solid var(--nx-border)', borderRadius: '8px'}}>
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem', marginTop: '2rem'}}>
  <a href="/overview" style={{padding: '1.5rem', border: '1px solid var(--nx-border)', borderRadius: '8px', textDecoration: 'none', color: 'inherit', display: 'block'}}>
    <h3>📖 Learn More</h3>
    <p>Understand what TimeTiles is and how it works</p>
  </a>
  <a href="/quick-start" style={{padding: '1.5rem', border: '1px solid var(--nx-border)', borderRadius: '8px', textDecoration: 'none', color: 'inherit', display: 'block'}}>
    <h3>🚀 Quick Start</h3>
    <p>Get TimeTiles running locally in minutes</p>
  </a>
  <a href="/guides/user-guide" style={{padding: '1.5rem', border: '1px solid var(--nx-border)', borderRadius: '8px', textDecoration: 'none', color: 'inherit', display: 'block'}}>
    <h3>🎯 User Guide</h3>
