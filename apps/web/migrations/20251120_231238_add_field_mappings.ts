...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "payload"."dataset_schemas" ADD COLUMN "field_mappings_title_path" varchar;
  ALTER TABLE "payload"."dataset_schemas" ADD COLUMN "field_mappings_description_path" varchar;
  ALTER TABLE "payload"."dataset_schemas" ADD COLUMN "field_mappings_timestamp_path" varchar;
  ALTER TABLE "payload"."_dataset_schemas_v" ADD COLUMN "version_field_mappings_title_path" varchar;
  ALTER TABLE "payload"."_dataset_schemas_v" ADD COLUMN "version_field_mappings_description_path" varchar;
  ALTER TABLE "payload"."_dataset_schemas_v" ADD COLUMN "version_field_mappings_timestamp_path" varchar;
  ALTER TABLE "payload"."import_jobs" ADD COLUMN "detected_field_mappings_title_path" varchar;
  ALTER TABLE "payload"."import_jobs" ADD COLUMN "detected_field_mappings_description_path" varchar;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "payload"."dataset_schemas" DROP COLUMN "field_mappings_title_path";
  ALTER TABLE "payload"."dataset_schemas" DROP COLUMN "field_mappings_description_path";
  ALTER TABLE "payload"."dataset_schemas" DROP COLUMN "field_mappings_timestamp_path";
  ALTER TABLE "payload"."_dataset_schemas_v" DROP COLUMN "version_field_mappings_title_path";
  ALTER TABLE "payload"."_dataset_schemas_v" DROP COLUMN "version_field_mappings_description_path";
  ALTER TABLE "payload"."_dataset_schemas_v" DROP COLUMN "version_field_mappings_timestamp_path";
  ALTER TABLE "payload"."import_jobs" DROP COLUMN "detected_field_mappings_title_path";
  ALTER TABLE "payload"."import_jobs" DROP COLUMN "detected_field_mappings_description_path";
