...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TYPE "payload"."enum_ingest_jobs_last_successful_stage" ADD VALUE 'create-schema-version' BEFORE 'geocode-batch';
  ALTER TYPE "payload"."enum__ingest_jobs_v_version_last_successful_stage" ADD VALUE 'create-schema-version' BEFORE 'geocode-batch';
