// @ts-nocheck — Generated by scripts/generate-payload.ts (circular type references)
/* tslint:disable */
/* eslint-disable */
/**
...
export const deletion_audit_log = db_schema.table(
  ...
  {
    id: serial("id").primaryKey(),
    deletedUserId: numeric("deleted_user_id", { mode: "number" }).notNull(),
  ...
  (columns) => [
    index("deletion_audit_log_deleted_user_id_idx").on(columns.deletedUserId),
    index("deletion_audit_log_deleted_at_idx").on(columns.deletedAt),
    index("deletion_audit_log_deleted_by_idx").on(columns.deletedBy),
    index("deletion_audit_log_updated_at_idx").on(columns.updatedAt),
    index("deletion_audit_log_created_at_idx").on(columns.createdAt),
  ]
);
...
export const payload_locked_documents_rels = db_schema.table(
  ...
  (columns) => [
    ...
    index("payload_locked_documents_rels_deletion_audit_log_id_idx").on(columns["deletion-audit-logID"]),
