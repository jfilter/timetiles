...
export const enum_deletion_audit_log_deletion_type = db_schema.enum("enum_deletion_audit_log_deletion_type", [
  "self",
  "admin",
  "scheduled",
]);
...
export const data_exports = db_schema.table(
  ...
  (columns) => ({
    data_exports_user_idx: index("data_exports_user_idx").on(columns.user),
    data_exports_expires_at_idx: index("data_exports_expires_at_idx").on(columns.expiresAt),
    data_exports_updated_at_idx: index("data_exports_updated_at_idx").on(columns.updatedAt),
    data_exports_created_at_idx: index("data_exports_created_at_idx").on(columns.createdAt),
  })
);
...
export const datasets = db_schema.table(
  "datasets",
  {
    ...
    catalogCreatorId: numeric("catalog_creator_id"),
...
export const _datasets_v = db_schema.table(
  ...
  (columns) => ({
    ...
    _datasets_v_version_version_catalog_creator_id_idx: index("_datasets_v_version_version_catalog_creator_id_idx").on(
      columns.version_catalogCreatorId
    ),
    _datasets_v_version_version_catalog_is_public_idx: index("_datasets_v_version_version_catalog_is_public_idx").on(
...
export const deletion_audit_log = db_schema.table(
  "deletion_audit_log",
  {
    id: serial("id").primaryKey(),
    deletedUserId: numeric("deleted_user_id").notNull(),
    deletedUserEmailHash: varchar("deleted_user_email_hash").notNull(),
    ...
    deletionType: enum_deletion_audit_log_deletion_type("deletion_type").notNull(),
    reason: varchar("reason"),
    dataTransferred: jsonb("data_transferred"),
  ...
  (columns) => ({
    deletion_audit_log_deleted_user_id_idx: index("deletion_audit_log_deleted_user_id_idx").on(columns.deletedUserId),
    deletion_audit_log_deleted_at_idx: index("deletion_audit_log_deleted_at_idx").on(columns.deletedAt),
    deletion_audit_log_deleted_by_idx: index("deletion_audit_log_deleted_by_idx").on(columns.deletedBy),
    deletion_audit_log_updated_at_idx: index("deletion_audit_log_updated_at_idx").on(columns.updatedAt),
    deletion_audit_log_created_at_idx: index("deletion_audit_log_created_at_idx").on(columns.createdAt),
  })
);
...
export const import_jobs = db_schema.table(
  "import_jobs",
  {
    ...
    progress_overallPercentage: numeric("progress_overall_percentage").default("0"),
...
export const _import_jobs_v = db_schema.table(
  "_import_jobs_v",
  {
    ...
    version_progress_overallPercentage: numeric("version_progress_overall_percentage").default("0"),
...
export const scheduled_imports_multi_sheet_config_sheets = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("scheduled_imports_multi_sheet_config_sheets_order_idx").on(columns._order),
    _parentIDIdx: index("scheduled_imports_multi_sheet_config_sheets_parent_id_idx").on(columns._parentID),
    scheduled_imports_multi_sheet_config_sheets_dataset_idx: index(
      "scheduled_imports_multi_sheet_config_sheets_dataset_idx"
    ).on(columns.dataset),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const _scheduled_imports_v = db_schema.table(
  "_scheduled_imports_v",
  {
    ...
    version_advancedOptions_timeoutMinutes: numeric("version_advanced_options_timeout_minutes").default("30"),
  ...
  (columns) => ({
    ...
    _scheduled_imports_v_version_version_created_by_idx: index(
      "_scheduled_imports_v_version_version_created_by_idx"
...
export const events = db_schema.table(
  "events",
  {
    ...
    catalogOwnerId: numeric("catalog_owner_id"),
  ...
  (columns) => ({
    ...
    events_dataset_is_public_idx: index("events_dataset_is_public_idx").on(columns.datasetIsPublic),
    events_catalog_owner_id_idx: index("events_catalog_owner_id_idx").on(columns.catalogOwnerId),
    ...
    location_longitude_idx: index("location_longitude_idx").on(columns.location_longitude),
    location_latitude_idx: index("location_latitude_idx").on(columns.location_latitude),
  })
);
...
export const _events_v = db_schema.table(
  ...
  (columns) => ({
    ...
    _events_v_version_version_dataset_is_public_idx: index("_events_v_version_version_dataset_is_public_idx").on(
      columns.version_datasetIsPublic
    ),
    _events_v_version_version_catalog_owner_id_idx: index("_events_v_version_version_catalog_owner_id_idx").on(
    ...
    version_location_longitude_idx: index("version_location_longitude_idx").on(columns.version_location_longitude),
    version_location_latitude_idx: index("version_location_latitude_idx").on(columns.version_location_latitude),
  })
);
...
export const user_usage = db_schema.table(
  "user_usage",
  {
    ...
    urlFetchesToday: numeric("url_fetches_today").default("0"),
    fileUploadsToday: numeric("file_uploads_today").default("0"),
    importJobsToday: numeric("import_jobs_today").default("0"),
    currentActiveSchedules: numeric("current_active_schedules").default("0"),
    totalEventsCreated: numeric("total_events_created").default("0"),
    currentCatalogs: numeric("current_catalogs").default("0"),
  ...
  (columns) => ({
    user_usage_user_idx: uniqueIndex("user_usage_user_idx").on(columns.user),
    user_usage_last_reset_date_idx: index("user_usage_last_reset_date_idx").on(columns.lastResetDate),
    user_usage_updated_at_idx: index("user_usage_updated_at_idx").on(columns.updatedAt),
    user_usage_created_at_idx: index("user_usage_created_at_idx").on(columns.createdAt),
    user_usage_deleted_at_idx: index("user_usage_deleted_at_idx").on(columns.deletedAt),
  })
);
...
export const pages_blocks_hero_buttons = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("pages_blocks_hero_buttons_order_idx").on(columns._order),
    _parentIDIdx: index("pages_blocks_hero_buttons_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const pages_blocks_details_grid_items = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("pages_blocks_details_grid_items_order_idx").on(columns._order),
    _parentIDIdx: index("pages_blocks_details_grid_items_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const pages_blocks_details_grid = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("pages_blocks_details_grid_order_idx").on(columns._order),
    _parentIDIdx: index("pages_blocks_details_grid_parent_id_idx").on(columns._parentID),
    _pathIdx: index("pages_blocks_details_grid_path_idx").on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [pages.id],
...
export const pages_blocks_testimonials_items = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("pages_blocks_testimonials_items_order_idx").on(columns._order),
    _parentIDIdx: index("pages_blocks_testimonials_items_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const pages_blocks_newsletter_form = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("pages_blocks_newsletter_form_order_idx").on(columns._order),
    _parentIDIdx: index("pages_blocks_newsletter_form_parent_id_idx").on(columns._parentID),
    _pathIdx: index("pages_blocks_newsletter_form_path_idx").on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [pages.id],
...
export const _pages_v_blocks_hero_buttons = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_pages_v_blocks_hero_buttons_order_idx").on(columns._order),
    _parentIDIdx: index("_pages_v_blocks_hero_buttons_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const _pages_v_blocks_details_grid_items = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_pages_v_blocks_details_grid_items_order_idx").on(columns._order),
    _parentIDIdx: index("_pages_v_blocks_details_grid_items_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const _pages_v_blocks_details_grid = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_pages_v_blocks_details_grid_order_idx").on(columns._order),
    _parentIDIdx: index("_pages_v_blocks_details_grid_parent_id_idx").on(columns._parentID),
    _pathIdx: index("_pages_v_blocks_details_grid_path_idx").on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_pages_v.id],
...
export const _pages_v_blocks_testimonials_items = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_pages_v_blocks_testimonials_items_order_idx").on(columns._order),
    _parentIDIdx: index("_pages_v_blocks_testimonials_items_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const _pages_v_blocks_newsletter_form = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_pages_v_blocks_newsletter_form_order_idx").on(columns._order),
    _parentIDIdx: index("_pages_v_blocks_newsletter_form_parent_id_idx").on(columns._parentID),
    _pathIdx: index("_pages_v_blocks_newsletter_form_path_idx").on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_pages_v.id],
...
export const payload_locked_documents_rels = db_schema.table(
  "payload_locked_documents_rels",
  {
    ...
    "deletion-audit-logID": integer("deletion_audit_log_id"),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_data_exports_id_idx: index("payload_locked_documents_rels_data_exports_id_idx").on(
    ...
    payload_locked_documents_rels_deletion_audit_log_id_idx: index(
      "payload_locked_documents_rels_deletion_audit_log_id_idx"
    ).on(columns["deletion-audit-logID"]),
    ...
    payload_locked_documents_rels_user_usage_id_idx: index("payload_locked_documents_rels_user_usage_id_idx").on(
    ...
    "deletion-audit-logIdFk": foreignKey({
      columns: [columns["deletion-audit-logID"]],
      foreignColumns: [deletion_audit_log.id],
      name: "payload_locked_documents_rels_deletion_audit_log_fk",
    }).onDelete("cascade"),
...
export const footer = db_schema.table(
  ...
  (columns) => ({
    footer__status_idx: index("footer__status_idx").on(columns._status),
  })
);
...
export const _footer_v_version_social_links = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_footer_v_version_social_links_order_idx").on(columns._order),
    _parentIDIdx: index("_footer_v_version_social_links_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const _footer_v_version_columns_links = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_footer_v_version_columns_links_order_idx").on(columns._order),
    _parentIDIdx: index("_footer_v_version_columns_links_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
...
export const _footer_v_version_columns = db_schema.table(
  ...
  (columns) => ({
    _orderIdx: index("_footer_v_version_columns_order_idx").on(columns._order),
    _parentIDIdx: index("_footer_v_version_columns_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_footer_v.id],
...
export const _footer_v = db_schema.table(
  ...
  (columns) => ({
    _footer_v_version_version__status_idx: index("_footer_v_version_version__status_idx").on(columns.version__status),
    _footer_v_created_at_idx: index("_footer_v_created_at_idx").on(columns.createdAt),
    _footer_v_updated_at_idx: index("_footer_v_updated_at_idx").on(columns.updatedAt),
    _footer_v_latest_idx: index("_footer_v_latest_idx").on(columns.latest),
    _footer_v_autosave_idx: index("_footer_v_autosave_idx").on(columns.autosave),
  })
);
...
export const branding = db_schema.table(
  ...
  (columns) => ({
    branding_logo_light_idx: index("branding_logo_light_idx").on(columns.logoLight),
    branding_logo_dark_idx: index("branding_logo_dark_idx").on(columns.logoDark),
    branding_favicon_source_light_idx: index("branding_favicon_source_light_idx").on(columns.faviconSourceLight),
    branding_favicon_source_dark_idx: index("branding_favicon_source_dark_idx").on(columns.faviconSourceDark),
  })
);
...
export const settings_geocoding_provider_selection_required_tags = db_schema.table(
  ...
  (columns) => ({
    orderIdx: index("settings_geocoding_provider_selection_required_tags_order_idx").on(columns.order),
    parentIdx: index("settings_geocoding_provider_selection_required_tags_parent_idx").on(columns.parent),
    parentFk: foreignKey({
      columns: [columns["parent"]],
...
export const settings = db_schema.table("settings", {
  ...
  geocoding_caching_ttlDays: numeric("geocoding_caching_ttl_days").default("30"),
...
export const relations_deletion_audit_log = relations(deletion_audit_log, ({ one }) => ({
  deletedBy: one(users, {
    fields: [deletion_audit_log.deletedBy],
    references: [users.id],
...
export const relations_payload_locked_documents_rels = relations(payload_locked_documents_rels, ({ one }) => ({
  ...
  "deletion-audit-logID": one(deletion_audit_log, {
    fields: [payload_locked_documents_rels["deletion-audit-logID"]],
    references: [deletion_audit_log.id],
    relationName: "deletion-audit-log",
  }),
...
type DatabaseSchema = {
  ...
  enum_deletion_audit_log_deletion_type: typeof enum_deletion_audit_log_deletion_type;
  ...
  deletion_audit_log: typeof deletion_audit_log;
  ...
  relations_deletion_audit_log: typeof relations_deletion_audit_log;
