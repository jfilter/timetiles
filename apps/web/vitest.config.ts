    ...
    projects: [
      {
        ...
        test: {
          ...
          exclude: ["tests/unit/services/cache/**/*.test.ts", "tests/unit/jobs/event-creation-helpers.test.ts"],
      ...
      },
      {
        ...
        test: {
          ...
          globals: true,
          environment: "node",
          include: ["tests/unit/services/cache/**/*.test.ts", "tests/unit/jobs/event-creation-helpers.test.ts"],
          setupFiles: ["tests/setup/unit/global-setup-minimal.ts"],
          testTimeout: 10000,
          hookTimeout: 10000,
          isolate: true,
