    ...
    projects: [
      {
        ...
        test: {
          ...
          testTimeout: 10000,
          hookTimeout: 10000,
          // Each test file gets a fresh worker — module mocks (`vi.mock`),
          // fake timers, and process/network resources cannot leak across
          // files. Worth the per-file setup cost given how many unit tests
          // mock src modules or use system resources.
          isolate: true,
        },
      },
      {
