...
/**
 * Unit tests for the GET /api/ingest/preview-schema route.
 *
...
const createGetRequest = (previewId: string) => {
  return new Request(`http://localhost/api/ingest/preview-schema?previewId=${previewId}`, {
    method: "GET",
...
describe.sequential("GET /api/ingest/preview-schema", () => {
  beforeEach(() => {
