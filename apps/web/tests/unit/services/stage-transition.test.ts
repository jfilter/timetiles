...
describe.sequential("StageTransitionService", () => {
  ...
  describe("race condition prevention", () => {
    it("should prevent duplicate transitions for the same job", async () => {
      ...
      // oxlint-disable-next-line @typescript-eslint/no-misused-promises -- intentional: mock returns promise to simulate async queue delay
  ...
  describe("utility methods", () => {
    ...
    it("should clear all transition locks", () => {
      ...
      // oxlint-disable-next-line @typescript-eslint/no-misused-promises -- intentional: mock returns never-resolving promise to hold transition lock
