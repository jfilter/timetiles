/**
 * Unit tests for scheduled imports timezone support in beforeChange hook.
 *
...
import { beforeChangeHook } from "@/lib/collections/scheduled-imports/hooks";

describe("scheduled-imports beforeChange hook timezone support", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.useFakeTimers();
  });
