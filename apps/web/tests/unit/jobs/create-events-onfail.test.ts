...
// onFail's rollback now runs under the per-dataset lease; stub it to a no-op lease
// (the lease's real behavior is covered in tests/integration/database/dataset-import-lock).
