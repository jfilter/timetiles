...
export async function isDatabaseAvailable(): Promise<boolean> {
  const dbUrl = process.env.DATABASE_URL || "postgresql://timetiles_user:timetiles_password@localhost:5432/timetiles_test";
 ...
 */
export async function skipIfNoDatabase(testName?: string): Promise<void> {
