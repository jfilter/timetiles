...
/**
 * Security tests verifying import-file creation validates catalog ownership.
 *
 * The vulnerability: any authenticated user could create an import-file
...
describe.sequential("Import File Foreign Resource Vulnerability", () => {
  ...
  describe("Vulnerability: foreign catalog on import-file create", () => {
    it("should reject creating import-file with another user's private catalog", async () => {
      await expect(
        payload.create({
