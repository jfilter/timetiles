...
const clientEntry: Record<string, string> = {
  ...
  "components/error-message": "./src/components/error-message.tsx",
  ...
  "components/labeled-slider": "./src/components/labeled-slider.tsx",
  "components/loading-state": "./src/components/loading-state.tsx",
  "components/map-control-popover": "./src/components/map-control-popover.tsx",
  ...
  "components/preset-button-group": "./src/components/preset-button-group.tsx",
...
const serverEntry: Record<string, string> = {
  ...
  "components/map-control-button": "./src/components/map-control-button.tsx",
