/**
 * Bluesky Icon - Social media
 *
 * Cartographic-style icon for Bluesky social platform.
 *
 * @module
 * @category Icons
 */
...
export const BlueskyIcon = React.forwardRef<SVGSVGElement, IconProps>(({ size = 24, className, ...props }, ref) => (
