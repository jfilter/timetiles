...
const statsVariants = cva("py-20", {
  variants: { variant: { bar: "bg-primary", grid: "bg-card", inline: "bg-background" } },
...
const statsGridVariants = cva("", {
  variants: {
    ...
    alignment: { center: "text-center", left: "text-left", right: "text-right" },
  },
  defaultVariants: { columns: 3, alignment: "center" },
});
